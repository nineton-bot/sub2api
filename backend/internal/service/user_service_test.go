...
func (m *mockUserRepo) UpdateReferralUsable(context.Context, int64, float64) error {
	return nil
}
...
func (m *mockBillingCache) GetSubscriptionCache(context.Context, int64, int64, int64) (*SubscriptionCacheData, error) {
	return nil, nil
}
func (m *mockBillingCache) SetSubscriptionCache(context.Context, int64, int64, int64, *SubscriptionCacheData) error {
	return nil
}
func (m *mockBillingCache) UpdateSubscriptionUsage(context.Context, int64, int64, int64, float64) error {
	return nil
}
func (m *mockBillingCache) UpdateSubscriptionRequestCount(context.Context, int64, int64, int64, int) error {
	return nil
}
