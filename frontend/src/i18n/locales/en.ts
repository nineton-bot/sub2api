export default {
  ...
  auth: {
    ...
    newUserBonus: '🎁 New user exclusive: receive ¥{amount} bonus balance automatically after your first payment.',
  ...
  keys: {
    ...
    useKeyModal: {
      ...
      modelPanel: {
        ...
        note: 'The Anthropic protocol is recommended for the best compatibility.',
        copyHint: 'Click any model name to copy',
        pill: 'Models',
        collapse: 'Collapse',
      },
    },
  ...
  invoices: {
    ...
    voidRequest: {
      ...
      button: 'Request void',
      warning: 'Once approved, the invoice will be voided and a red-letter invoice will be issued automatically. This action cannot be undone.',
      reasonLabel: 'Reason for voiding',
      reasonPlaceholder: 'Please explain why this invoice should be voided (e.g., wrong title, order refunded)',
      submit: 'Submit request',
      pendingBadge: 'Void request pending',
      pendingTooltip: 'Submitted at {time}, reason: {reason}',
    },
    fields: {
  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        meterNotEditable: 'Subscription meter cannot be changed after group creation.',
        ...
        dailyRequestLimit: '24h Request Limit',
        weeklyRequestLimit: '7d Request Limit',
        monthlyRequestLimit: '30d Request Limit',
        defaultValidityDays: 'Default Validity (Days)',
        validityHint: 'Number of days the subscription is valid when assigned to a user',
        noLimit: 'No limit',
        notSubscription: 'Not a subscription group'
      },
      imagePricing: {
    ...
    accounts: {
      ...
      quotaLimitHint: 'Set daily/weekly/total account limits, measured either by cost or request count. Anthropic API key accounts can also configure client affinity. Changing limits won\'t reset usage.',
      ...
      quotaMeter: 'Limit Type',
      quotaMeterCost: 'Cost',
      quotaMeterRequests: 'Request Count',
      quotaDailyLimit: 'Daily Limit',
      quotaDailyLimitHint: 'Automatically resets every 24 hours from first usage.',
      quotaDailyLimitHintRequests: 'Automatically resets every 24 hours from first usage, counted by requests.',
      quotaWeeklyLimit: 'Weekly Limit',
      quotaWeeklyLimitHint: 'Automatically resets every 7 days from first usage.',
      quotaWeeklyLimitHintRequests: 'Automatically resets every 7 days from first usage, counted by requests.',
      quotaTotalLimit: 'Total Limit',
      quotaTotalLimitHint: 'Cumulative spending limit. Does not auto-reset — use "Reset Quota" to clear.',
      quotaTotalLimitHintRequests: 'Cumulative request-count limit. Does not auto-reset — use "Reset Quota" to clear.',
  ...
  payment: {
    ...
    amountHint: '💡 Payment is in CNY (¥). Charged as ¥1 = $1 credit — no FX spread.',
    ...
    qr: {
      ...
      popupBlockedHint: 'If the new window did not open automatically, your browser may have blocked it. Click the button above to open it manually.',
  ...
  referral: {
    ...
    copyCode: 'Copy Code',
    copied: 'Copied',
    stealthModeLabel: 'Hide referral trace',
    stealthModeHint: 'When on, the invite link is a short /g/xxx URL. Invitees see a clean /register URL without ref parameter, and the register page hides the inviter name.',
    stealthModeActive: 'Stealth mode is on: the link looks like a plain short URL, suitable for contexts where you prefer not to reveal promotion intent.',
