export default {
  ...
  auth: {
    ...
    newUserBonus: '🎁 新人专享福利：完成首次充值或订阅后，自动获得 ¥{amount} 体验金',
  ...
  invoices: {
    ...
    voidRequest: {
      title: '申请作废发票',
      button: '申请作废',
      warning: '作废申请通过后，原发票将不可恢复，并自动开具红冲票。请确认信息无误后再提交。',
      reasonLabel: '作废原因',
      reasonPlaceholder: '请说明申请作废的原因（如抬头错误、订单退货等）',
      submit: '提交申请',
      pendingBadge: '作废申请审批中',
      pendingTooltip: '已提交于 {time}，原因：{reason}',
    },
    fields: {
      titleSection: '开票信息',
      title: '发票抬头',
  ...
  admin: {
    ...
    groups: {
      ...
      subscription: {
        ...
        meter: '订阅计量方式',
        meterNotEditable: '分组创建后无法修改订阅计量方式。',
        standard: '标准（余额）',
        subscription: '订阅（配额）',
        costQuota: '金额额度',
        requestQuota: '请求次数',
        ...
        dailyRequestLimit: '24h 请求上限',
        weeklyRequestLimit: '7d 请求上限',
        monthlyRequestLimit: '30d 请求上限',
        defaultValidityDays: '默认有效期（天）',
        validityHint: '分配给用户时订阅的有效天数',
        noLimit: '无限制',
        notSubscription: '非订阅分组'
      },
      imagePricing: {
        title: '图片生成计费',
    ...
    accounts: {
      ...
      quotaLimitHint: '设置日/周/总使用限额，可按金额或请求次数计量。任一维度达到限额后账号暂停调度。Anthropic API Key 账号还可配置客户端亲和。修改限额不会重置已用额度。',
      quotaLimitToggle: '启用配额限制',
      quotaLimitToggleHint: '开启后，当账号用量达到设定额度时自动暂停调度',
      quotaMeter: '限额类型',
      quotaMeterCost: '金额',
      quotaMeterRequests: '请求次数',
      quotaDailyLimit: '日限额',
      quotaDailyLimitHint: '从首次使用起每 24 小时自动重置。',
      quotaDailyLimitHintRequests: '从首次使用起每 24 小时按请求次数自动重置。',
      quotaWeeklyLimit: '周限额',
      quotaWeeklyLimitHint: '从首次使用起每 7 天自动重置。',
      quotaWeeklyLimitHintRequests: '从首次使用起每 7 天按请求次数自动重置。',
      quotaTotalLimit: '总限额',
      quotaTotalLimitHint: '累计消费上限，不会自动重置 — 使用「重置配额」手动清零。',
      quotaTotalLimitHintRequests: '累计请求次数上限，不会自动重置 — 使用「重置配额」手动清零。',
      quotaResetMode: '重置方式',
  ...
  payment: {
    ...
    customAmount: '自定义金额',
    enterAmount: '输入金额',
    amountHint: '💡 支付金额单位为人民币（¥），按 ¥1 = $1 额度到账，无汇率差',
    paymentMethod: '支付方式',
    fee: '手续费',
    actualPay: '实付金额',
    createOrder: '确认支付',
    ...
    qr: {
      ...
      popupBlockedHint: '若未自动弹出新窗口，可能被浏览器拦截，点击上方按钮可手动打开',
      expiresIn: '剩余支付时间',
      expired: '订单已过期',
  ...
  referral: {
    ...
    copyCode: '复制邀请码',
    copied: '已复制',
    stealthModeLabel: '隐藏推广痕迹',
    stealthModeHint: '开启后，邀请链接改为 /g/xxx 短链形式；被邀请人点开后 URL 不显示 ref 参数，注册页也不展示邀请人昵称',
    stealthModeActive: '当前为隐藏模式：链接对外看起来像普通短链，适合在不方便暴露推广意图的场合分享',
    qrTitle: '扫码注册',
    downloadQr: '下载二维码',
    statGross: '累计佣金',
    statReleased: '累计已释放',
