...
<template>
  ...
  >
    ...
    <span class="font-mono">{{ props.unit === 'requests' ? fmt(used) : `$${fmt(used)}` }}</span>
    <span class="text-gray-400 dark:text-gray-500">/</span>
    <span class="font-mono">{{ props.unit === 'requests' ? fmt(limit) : `$${fmt(limit)}` }}</span>
  </span>
</template>
