...
const handleCreateGroup = async () => {
  ...
  try {
    ...
    const requestData = {
      ...
      daily_request_limit: normalizeOptionalLimit(
        createForm.daily_request_limit as number | string | null,
      ),
      weekly_request_limit: normalizeOptionalLimit(
        createForm.weekly_request_limit as number | string | null,
      ),
      monthly_request_limit: normalizeOptionalLimit(
        createForm.monthly_request_limit as number | string | null,
      ),
...
const handleUpdateGroup = async () => {
  ...
  try {
    ...
    const payload = {
      ...
      daily_request_limit: normalizeOptionalLimit(
        editForm.daily_request_limit as number | string | null,
      ),
      weekly_request_limit: normalizeOptionalLimit(
        editForm.weekly_request_limit as number | string | null,
      ),
      monthly_request_limit: normalizeOptionalLimit(
        editForm.monthly_request_limit as number | string | null,
      ),
      fallback_group_id:
